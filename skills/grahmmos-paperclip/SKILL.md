...
If the heartbeat should refresh the markdown and JSON runtime artifacts together, run
...
issue-update payload for the execution contract, plus timestamped archive copies
under `OUTPUT_DIR/history/`.
