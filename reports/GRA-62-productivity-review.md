...
- No GitHub PR titles or bodies returned by `gh pr list --search 'GRA-43 OR GRA-62'` mention either issue.
...
- Required action: provide Osiris Hermes with valid Paperclip board authentication in Cursor Cloud, such as injecting `PAPERCLIP_API_KEY` or another supported non-interactive credential for the private deployment
